...
<li class="breadcrumb-item active">Khusuf</li>
@endsection
@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-primary">Data Khusuf</div>

            <div class="card-body">
                <form action="{{ route('khusuf.index') }}" method="get">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="card @if(empty($data)) d-none @endif">
            ...
            <div class="card-body">
                <form action="{{ route('khusuf.create') }}" method="get">
                    @method('get')
                    @csrf
