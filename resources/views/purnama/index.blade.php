...
<li class="breadcrumb-item active">Purnama</li>
@endsection
@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-primary">Data Purnama</div>

            <div class="card-body">
                <form action="{{ route('purnama.index') }}" method="get">
                    <div class="row">
                        <div class="col-md-6">
        ...
        <div class="card @if(empty($data)) d-none @endif">
            ...
            <div class="card-body">
                <form action="{{ route('purnama.create') }}" method="get">
                    @method('get')
                    @csrf
